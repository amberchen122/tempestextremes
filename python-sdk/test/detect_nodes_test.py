...
"""bin/DetectNodes --in_data ./python-sdk/test/cn_files/e5.oper.fc.sfc.instan.228_003_zust.ll025sc.2023061606_2023070106.nc --timefilter "6hr" --out out1.dat 
...
param = DetectNodes.DetectNodesParameter(strInputFile = "./test/cn_files/e5.oper.fc.sfc.instan.228_003_zust.ll025sc.2023061606_2023070106.nc", 
...
# param.set_log_path("./log.txt")
# param.set_closed_contour_cmd([['MSL', '200.0', '5.5', '0'], ['_DIFF(Z(300hPa)', 'Z(500hPa))', '-58.8', '6.5', '1.0']])

# reg = DetectNodes.VariableRegistry()
